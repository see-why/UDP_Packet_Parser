...
class UdpSocketManager
  ...
  def send_packet(data, offset, dest_ip, dest_port, source_ip: ENV.fetch('SOURCE_IP', '192.168.1.100'), source_port: ENV.fetch('SOURCE_PORT', '5000'))
    ...
    @socket.send(ip_packet, offset, sockaddr)
  end
